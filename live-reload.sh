...
#     ~/.local/share/qutebrowser/userscripts/live-reload.sh
#
# 3. Make it executable with:
#     chmod +x ~/.local/share/qutebrowser/userscripts/live-reload.sh
#
...
#        bind <Ctrl+Shift+r> spawn --userscript -v -m live-reload.sh
...
reportAndReload () {
        ...
        echo ":run-with-count $QUTE_COUNT reload -f" > $QUTE_FIFO
}
